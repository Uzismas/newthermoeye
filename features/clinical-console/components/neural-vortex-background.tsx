...
/**
 * Interactive WebGL "neural vortex" background.
 * Adapted from 21st.dev (minhxthanh/interactive-neural-vortex-background).
 * Renders ONLY a full-viewport canvas — no hero content — so it can be dropped
 * behind the login card. Pointer interaction is driven from window-level
 * listeners, so it stays interactive even though the canvas is pointer-events:none.
 */
